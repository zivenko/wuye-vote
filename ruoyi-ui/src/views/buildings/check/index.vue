<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="小程序用户ID" prop="appletId">
        <el-input
      ...
      <el-form-item label="审核员ID" prop="userId">
        <el-input
    ...
    <el-table v-loading="loading" :data="checkList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="审核员ID" align="center" prop="userId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="小程序用户ID" prop="appletId">
          <el-input v-model="form.appletId" placeholder="请输入小程序用户ID" />
        </el-form-item>
        <el-form-item label="房屋ID" prop="houseId">
          <el-input v-model="form.houseId" placeholder="请输入房屋ID" />
        </el-form-item>
        <el-form-item label="房屋证明" prop="certificate">
          <el-input v-model="form.certificate" placeholder="请输入房屋证明" />
        </el-form-item>
        <el-form-item label="审核失败信息" prop="checkErrorMsg">
          <el-input v-model="form.checkErrorMsg" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="审核时间" prop="checkTime">
          <el-date-picker clearable
        ...
        <el-form-item label="审核员ID" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入审核员ID" />
        </el-form-item>
      </el-form>
